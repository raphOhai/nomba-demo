...
const EmenuSection4Black = ({ headingText, tools }) => {
  ...
  return (
    <div class=" bg-n-dark relative section-four mb-0">
      <Container className="">
        <SectionHeader>
          <div className="flex flex-row justify-center max-w-[753px] mx-auto pt-10">
            <Ntext variant="text8" color="primary">
              <div className="white-text">{headingText}</div>
            </Ntext>
          </div>
        </SectionHeader>
        <div ref={comp} className="min-h-[120vh] ">
          <div className="flex justify-start text-center pb-10 text-n-grey2 section-nav-link flex-row scrollbar-hide overflow-auto md:justify-center">
            {tools.map((t, i) => (
              <div
                key={t.title}
                className={`cursor-pointer transition-all  md:px-5 py-2  px-2 md:border-white inline-flex rounded-full section-four-title-${i} circle flex flex-col justify-center items-center text-white`}
              >
