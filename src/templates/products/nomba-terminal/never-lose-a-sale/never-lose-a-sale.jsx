...
export function NeverLoseASale({ link = { href: { url: nombaPro.dashdboardUrl } } }) {
  return (
    <div className="bg-n-dark">
      <SectionWrapper className={sectionContainer}>
        <div className={innerWrapper}>
          <div className={textSection}>
            <Ntext variant="h2" color="n-light" className="mb-[30px]">
              <>
          ...
          <div className={imageSection}>
            <StaticImage src={"../../../../assets/images/nomba-terminal-5.png"} height={430} width={427} alt="" />
          </div>
        </div>
      </SectionWrapper>
    </div>
