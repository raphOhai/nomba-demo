    ...
    <div className="bg-n-grey6">
      <SectionWrapper className={sectionContainer}>
        <p className={downloadText}>
          Download the Nomba app <span className={otherText}>on your phone to get started for free today</span>
        </p>

        <div>
          <NLink href={link}>
            <StaticImage src={"../../../../assets/images/google-play-badge.png"} alt="google download button" />
          </NLink>
        </div>
      </SectionWrapper>
    </div>
