  ...
  return (
    <div className="bg-[#fafafa]">
      <SectionWrapper className={sectionWrapper}>
        ...
        >
          Track growth effortlessly. Make or receive money transfers easily via
          the Nomba Pro terminal
        </Ntext>
        ...
        <div className="justify-center items-center flex">
          <StaticImage
            src="../../../../assets/images/pro-horizontal-list.png"
            alt="terminal horizontal images"
          />
        </div>
      </SectionWrapper>
    </div>
