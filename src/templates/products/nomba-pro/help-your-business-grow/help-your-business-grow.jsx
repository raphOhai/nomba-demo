      ...
      <SectionWrapper className={pageWrapper}>
          ...
          <div className={textContainer}>
            ...
            <div className="description">
              <Ntext color="n-grey5" variant="text3">
                With Nomba Pro, you’re able to accept payments on the go at
                lightning speed. The Nomba Pro Terminal also gets you started
                with getting right out of the box with unlimited and ultra fast
                4G connection for unlimited transactions.
              </Ntext>
            </div>
            <div className="action">
              <ReadMore
                text={nombaPro.orderText}
                color="n-dark"
                variant="text3"
                href={nombaPro.dashdboardUrl}
              />
            </div>
          </div>
        </div>
        ...
        <div className={`${alternateImgAndText} ${invertedCol}`}>
          <div className={textContainer}>
            ...
            <div className="description">
              <Ntext color="n-grey5" variant="text3">
                Nomba Pro offers you access to accepting payments anytime,
                anyday via bank transfer or debit cards quickly, easily, and
                securely. No more long waiting days for your money.
              </Ntext>
            </div>
            <div className="action">
              <ReadMore
