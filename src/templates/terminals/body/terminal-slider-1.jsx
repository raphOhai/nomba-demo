  ...
  const sliderItems = terminalData.map((posdetails, index) => {
    ...
    return (
      ...
      <SwiperSlide key={index} className="flex items-stretch">
        <div key={`pos_card_${index}`} className={`h-full relative py-8  md:min-w-[407px] ${posdetails.bgColor}`}>
    ...
    <div className={controlWrapStyle}>
      ...
      <div className="pagination-class !relative swiper-pagination-progressbar swiper-pagination-horizontal">
        <span
          ...
          style={{
            transform: `translate3d(0px, 0px, 0px) scaleX(${ref.current.swiper.progressLoop}) scaleY(1)`,
